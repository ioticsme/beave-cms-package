try {
    ...
    var BEAVERDatatablesServerSide = (function () {
        ...
        var initDatatable = function () {
            dt = $('#beaver_datatable_example_1').DataTable({
                searchDelay: 500,
                processing: true,
                serverSide: true,
                order: [[5, 'desc']],
                ...
                ajax: {
                    url: `/admin/ecommerce/orders/ajax`,
                    // url: "https://preview.keenthemes.com/api/datatables.php",
                },
                columns: [
                    { data: null },
                    { data: 'order_no', className: 'min-w-150px' },
                    { data: 'user.first_name', className: 'min-w-150px' },
                    {
                        data: 'payment_status',
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return `<a class="text-gray-800 text-hover-primary fw-bold" href="/admin/ecommerce/orders/detail/${row._id}"> ${data}</a>`
                        },
                    },
                    {
                        targets: 2,
                        orderable: false,
                        render: function (data, type, row) {
                            return `<div class="text-gray-800 text-hover-primary fw-bold" > ${data}</div>`
                        },
                    },
                    {
                        targets: 3,
                        ...
                        render: function (data, type, row) {
                            if (data == 'success') {
                                ...
                                return `<div class="badge badge-danger">On Hold</div>`
                            } else if (data == 'pending') {
                                return `<div class="badge badge-light-danger">Pending</div>`
                            }
                        },
                    },
                    {
            ...
            let e = document.querySelector('#beaver_ecommerce_sales_flatpickr')
            var n = $(e).flatpickr({
                altInput: !0,
                altFormat: 'd/m/Y',
                dateFormat: 'Y-m-d',
        ...
        //     const container = document.querySelector('#beaver_datatable_example_1')
