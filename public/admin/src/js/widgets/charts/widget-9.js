...
// Class definition
var BEAVERChartsWidget9 = (function () {
    var chart = {
        self: null,
        rendered: false,
    }
    ...
    var initChart = function () {
        var element = document.getElementById('beaver_charts_widget_9')
        ...
        var labelColor = BEAVERUtil.getCssVariableValue('--bs-gray-400')
        var borderColor = BEAVERUtil.getCssVariableValue(
            '--bs-border-dashed-color'
        )

        var baseColor = BEAVERUtil.getCssVariableValue('--bs-gray-200')
        var secondaryColor = BEAVERUtil.getCssVariableValue('--bs-primary')
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERChartsWidget9
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERChartsWidget9.init()
})
