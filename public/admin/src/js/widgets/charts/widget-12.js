...
// Class definition
var BEAVERChartsWidget12 = (function () {
    // Private methods
    ...
    return {
        init: function () {
            initChart(
                '#beaver_charts_widget_12_tab_1',
                '#beaver_charts_widget_12_chart_1',
                [54, 42, 75, 110, 23, 87, 50],
                true
            )
            initChart(
                '#beaver_charts_widget_12_tab_2',
                '#beaver_charts_widget_12_chart_2',
                [25, 55, 35, 50, 45, 20, 31],
                false
            )
            initChart(
                '#beaver_charts_widget_12_tab_3',
                '#beaver_charts_widget_12_chart_3',
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERChartsWidget12
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERChartsWidget12.init()
})
