...
// Class definition
var BEAVEChartsWidget37 = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    return {
        init: function () { 
            ...
            initChart(chart1, '#beave_charts_widget_37_tab_1', '#beave_charts_widget_37_chart_1', chart1Data, chart1Labels, true);
            ...
            initChart(chart2, '#beave_charts_widget_37_tab_2', '#beave_charts_widget_37_chart_2', chart2Data, chart2Labels, false);
            ...
            initChart(chart3, '#beave_charts_widget_37_tab_3', '#beave_charts_widget_37_chart_3', chart3Data, chart3Labels, false);
            ...
            initChart(chart4, '#beave_charts_widget_37_tab_4', '#beave_charts_widget_37_chart_4', chart4Data, chart4Labels, false);  
            ...
            BEAVEThemeMode.on("beave.thememode.change", function() {
                ...
                initChart(chart1, '#beave_charts_widget_37_tab_1', '#beave_charts_widget_37_chart_1', chart1Data, chart1Labels, chart1.rendered);
                initChart(chart2, '#beave_charts_widget_37_tab_2', '#beave_charts_widget_37_chart_2', chart2Data, chart2Labels, chart2.rendered);  
                initChart(chart3, '#beave_charts_widget_37_tab_3', '#beave_charts_widget_37_chart_3', chart3Data, chart3Labels, chart3.rendered);
                initChart(chart4, '#beave_charts_widget_37_tab_4', '#beave_charts_widget_37_chart_4', chart4Data, chart4Labels, chart4.rendered);                 
            });
        }   
    }
}();
...
if (typeof module !== 'undefined') {
    module.exports = BEAVEChartsWidget37;
}

// On document ready
BEAVEUtil.onDOMContentLoaded(function() {
    BEAVEChartsWidget37.init();
});
