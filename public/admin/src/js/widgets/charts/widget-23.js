// Class definition
var BEAVEChartsWidget23 = (function () {
	// Private methods
	var initChart = function () {
		...
		var element = document.getElementById("beave_charts_widget_23");
		...
		var init = function() {
			...
			var series2 = chart.series.push(
				am5xy.LineSeries.new(root, {
					...
					stroke: am5.color(BEAVEUtil.getCssVariableValue("--bs-success")),
					tooltip: am5.Tooltip.new(root, {
						pointerOrientation: "horizontal",
						labelText: "{name} in {categoryX}: {valueY} {info}",
					}),
			...
			series2.bullets.push(function () {
				return am5.Bullet.new(root, {
					sprite: am5.Circle.new(root, {
						...
						stroke: am5.color(BEAVEUtil.getCssVariableValue("--bs-success")),
						radius: 5,
						fill: am5.color(BEAVEUtil.getCssVariableValue("--bs-success-light")),
					}),
				});
			});
...
if (typeof module !== "undefined") {
	module.exports = BEAVEChartsWidget23;
}

// On document ready
BEAVEUtil.onDOMContentLoaded(function () {
	BEAVEChartsWidget23.init();
});
