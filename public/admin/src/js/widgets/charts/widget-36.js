...
// Class definition
var BEAVERChartsWidget36 = (function () {
    var chart = {
        self: null,
        rendered: false,
    }
    ...
    var initChart = function (chart) {
        var element = document.getElementById('beaver_charts_widget_36')
        ...
        var baseprimaryColor = BEAVERUtil.getCssVariableValue('--bs-primary')
        var lightprimaryColor = BEAVERUtil.getCssVariableValue('--bs-primary')
        var basesuccessColor = BEAVERUtil.getCssVariableValue('--bs-success')
        var lightsuccessColor = BEAVERUtil.getCssVariableValue('--bs-success')
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERChartsWidget36
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERChartsWidget36.init()
})
