...
var BEAVETimelineWidget4 = function () {
    ...
    const initTimelineDay = () => {
        ...
        // Set variables
        var now = Date.now();
        var rootImagePath = element.getAttribute('data-beave-timeline-widget-4-image-root');
        ...
        var options = {
            ...
            onInitialDrawComplete: function () {
                ...
                const target = element.closest('[data-beave-timeline-widget-4-blockui="true"]');
    ...
    const handleBlockUI = () => {
        ...
        const elements = document.querySelectorAll('[data-beave-timeline-widget-4-blockui="true"]');
    ...
    const tabsVisibility = () => {
        const tabs = document.querySelectorAll('[data-beave-timeline-widget-4="tab"]');
