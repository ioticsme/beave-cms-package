...
// Class definition
var BEAVERTablesWidget15 = (function () {
    var chart1 = {
        self: null,
        rendered: false,
    }
    ...
    return {
        init: function () {
            ...
            initChart(
                chart1,
                '#beaver_table_widget_15_chart_1',
                chart1Data,
                true
            )
            ...
            initChart(
                chart2,
                '#beaver_table_widget_15_chart_2',
                chart2Data,
                true
            )
            ...
            initChart(
                chart3,
                '#beaver_table_widget_15_chart_3',
                chart3Data,
                true
            )
            ...
            initChart(
                chart4,
                '#beaver_table_widget_15_chart_4',
                chart4Data,
                true
            )
            ...
            initChart(
                chart5,
                '#beaver_table_widget_15_chart_5',
                chart5Data,
                true
            )
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERTablesWidget15
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERTablesWidget15.init()
})
