...
// Class definition
var BEAVERTablesWidget14 = (function () {
    var chart1 = {
        self: null,
        rendered: false,
    }
    ...
    var initChart = function (chart, chartSelector, data, initByDefault) {
        ...
        var lightColor = BEAVERUtil.getCssVariableValue('--bs-body-bg')
    ...
    return {
        init: function () {
            ...
            initChart(
                chart1,
                '#beaver_table_widget_14_chart_1',
                chart1Data,
                true
            )
            ...
            initChart(
                chart2,
                '#beaver_table_widget_14_chart_2',
                chart2Data,
                true
            )
            ...
            initChart(
                chart3,
                '#beaver_table_widget_14_chart_3',
                chart3Data,
                true
            )
            ...
            initChart(
                chart4,
                '#beaver_table_widget_14_chart_4',
                chart4Data,
                true
            )
            ...
            initChart(
                chart5,
                '#beaver_table_widget_14_chart_5',
                chart5Data,
                true
            )
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERTablesWidget14
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERTablesWidget14.init()
})
