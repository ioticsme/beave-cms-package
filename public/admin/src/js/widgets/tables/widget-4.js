...
// Class definition
var BEAVERTablesWidget4 = (function () {
    var table
    var datatable
    var template
    ...
    const initDatatable = () => {
        ...
        const subtable = document.querySelector(
            '[data-beaver-table-widget-4="subtable_template"]'
        )
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector(
            '[data-beaver-table-widget-4="search"]'
        )
    ...
    const handleStatusFilter = () => {
        const select = document.querySelector(
            '[data-beaver-table-widget-4="filter_status"]'
        )
    ...
    const handleActionButton = () => {
        const buttons = document.querySelectorAll(
            '[data-beaver-table-widget-4="expand_row"]'
        )
    ...
    const populateTemplate = (data, target) => {
        data.forEach((d, index) => {
            ...
            const image = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_image"]'
            )
            const name = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_name"]'
            )
            const description = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_description"]'
            )
            const cost = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_cost"]'
            )
            const qty = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_qty"]'
            )
            const total = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_total"]'
            )
            const stock = newTemplate.querySelector(
                '[data-beaver-table-widget-4="template_stock"]'
            )
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERTablesWidget4
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERTablesWidget4.init()
})
