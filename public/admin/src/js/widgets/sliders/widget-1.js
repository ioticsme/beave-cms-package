...
// Class definition
var BEAVERSlidersWidget1 = (function () {
    var chart1 = {
        self: null,
        rendered: false,
    }
    ...
    return {
        init: function () {
            // Init default chart
            initChart(chart1, '#beaver_slider_widget_1_chart_1', 76)

            var carousel = document.querySelector(
                '#beaver_sliders_widget_1_slider'
            )
            ...
            carousel.addEventListener('slid.bs.carousel', function (e) {
                if (e.to === 1) {
                    // Init second chart
                    initChart(chart2, '#beaver_slider_widget_1_chart_2', 55)
                }

                if (e.to === 2) {
                    // Init third chart
                    initChart(chart3, '#beaver_slider_widget_1_chart_3', 25)
                }
            })
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERSlidersWidget1
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERSlidersWidget1.init()
})
