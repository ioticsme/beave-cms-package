...
// Class definition
var BEAVERMapsWidget2 = (function () {
    // Private methods
    var initMap = function () {
        ...
        var element = document.getElementById('beaver_maps_widget_2_map')
        ...
        var init = function () {
            ...
            polygonSeries.mapPolygons.template.states.create('hover', {
                fill: am5.color(BEAVERUtil.getCssVariableValue('--bs-success')),
            })
            ...
            polygonSeriesHighlighted.mapPolygons.template.set(
                'fill',
                am5.color(BEAVERUtil.getCssVariableValue('--bs-primary'))
            )
...
if (typeof module !== 'undefined') {
    module.exports = BEAVERMapsWidget2
}

// On document ready
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERMapsWidget2.init()
})
