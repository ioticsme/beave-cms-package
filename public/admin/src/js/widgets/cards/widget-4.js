...
// Class definition
var BEAVECardsWidget4 = function () {
    // Private methods
    var initChart = function() {
        ...
        drawCircle(BEAVEUtil.getCssVariableValue('--bs-danger'), options.lineWidth, 100 / 150);
        drawCircle(BEAVEUtil.getCssVariableValue('--bs-primary'), options.lineWidth, 100 / 250);   
    }
...
if (typeof module !== 'undefined') {
    module.exports = BEAVECardsWidget4;
}

// On document ready
BEAVEUtil.onDOMContentLoaded(function() {
    BEAVECardsWidget4.init();
});
