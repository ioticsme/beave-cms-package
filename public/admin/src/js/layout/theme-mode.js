...
var BEAVERThemeMode = (function () {
    ...
    var setMode = function (mode, menuMode) {
        ...
        var activeMenuItem = menu
            ? menu.querySelector(
                  '[data-beaver-element="mode"][data-beaver-value="' +
                      menuMode +
                      '"]'
              )
            : null
        ...
        document.documentElement.setAttribute(
            'data-beaver-theme-mode-switching',
            'true'
        )
    ...
    var getMenuMode = function () {
        ...
        var menuItem = menu
            ? menu.querySelector('.active[data-beaver-element="mode"]')
            : null
    ...
    var setActiveMenuItem = function (item) {
        ...
        var activeItem = menu.querySelector(
            '.active[data-beaver-element="mode"]'
        )
    ...
    var handleMenu = function () {
        var items = [].slice.call(
            menu.querySelectorAll('[data-beaver-element="mode"]')
        )
    ...
    return {
        init: function () {
            menu = document.querySelector(
                '[data-beaver-element="theme-mode-menu"]'
            )
...
BEAVERUtil.onDOMContentLoaded(function () {
    BEAVERThemeMode.init()
})

// Declare BEAVERThemeMode for Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = BEAVERThemeMode
}
