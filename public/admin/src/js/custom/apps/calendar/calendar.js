...
var BEAVEAppCalendar = (function () {
    ...
    const handleNewEvent = () => {
        ...
        const datepickerWrappers = form.querySelectorAll(
            '[data-beave-calendar="datepicker"]'
        )

        // Handle all day toggle
        const allDayToggle = form.querySelector(
            '#beave_calendar_datepicker_allday'
        )
    ...
    const handleViewButton = () => {
        const viewButton = document.querySelector(
            '#beave_calendar_event_view_button'
        )
    ...
    return {
        ...
        init: function () {
            ...
            startDatepicker = form.querySelector(
                '#beave_calendar_datepicker_start_date'
            )
            endDatepicker = form.querySelector(
                '#beave_calendar_datepicker_end_date'
            )
            startTimepicker = form.querySelector(
                '#beave_calendar_datepicker_start_time'
            )
            endTimepicker = form.querySelector(
                '#beave_calendar_datepicker_end_time'
            )
